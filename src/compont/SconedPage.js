...
function SconedPage(){
    ...
    <div className="categories">
            <div className="container">
                <h2 style={{color:'#088179', fontWeight:'600'}}>Popular<span style={{color:'black', marginLeft:'5px'}}>Categories</span></h2>
                <div className="row">
                { products.slice(0, 8).map((product) =>{
                return( <>
                    <div key= {product.id} style={{padding:'30px'}} className="col-md-6 col-lg-4 mb-3">
                        <div key={product.id} style={{}} className="First-Section">
                            ...
                            <h5>{product.name}</h5> 
                                ...
                                <span style={{color:'#ffb300',fontSize:'18px'}}><AiFillStar/></span>
                                    ...
                                    <Link onClick={() => handle(product)}><FaCartPlus/></Link>
                                    </div>
                        </div>
                    </div>
                </>
